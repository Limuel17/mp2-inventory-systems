	  ...
	  <div class="row">
		...
		<h1 class="my-5"></h1>
		   ...
		   <div class="nav text flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false">
					<i class="material-icons">shopping_cart_checkout</i>
					<span>Purchase</span></a>

					<a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">
					<i class="material-icons">handshake</i>
					<span>Vendor</span></a>

					<a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="#v-pills-sale" role="tab" aria-controls="v-pills-sale" aria-selected="false">
					<i class="material-icons">point_of_sale</i>
					<span>Sale</span></a>

					<a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false">
					<i class="material-icons">groups</i>
					<span>Customer</span></a>

					<a class="nav-link" id="v-pills-search-tab" data-toggle="pill" href="#v-pills-search" role="tab" aria-controls="v-pills-search" aria-selected="false">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2023-05-24">
						</div>
						<div class="form-group col-md-2">
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="2023-05-24" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate" value="2023-05-24" name="saleReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate" value="2023-05-24" name="saleReportEndDate" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate" value="2023-05-24" name="purchaseReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate" value="2023-05-24" name="purchaseReportEndDate" readonly>
								  </div>
							  </div>
